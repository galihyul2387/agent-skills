...
| # | Module | Full Guides (4 Languages) | Core Scope & Summary | Ready Examples |
|:---:|:---|:---|:---|:---:|
| **01** | **Planning & PRD** | [ID](skills/01-planning/SKILL.md) \| [EN](skills/01-planning/SKILL.en.md) \| [ZH](skills/01-planning/SKILL.zh.md) \| [AR](skills/01-planning/SKILL.ar.md) | Scope definition, PRD, User Stories, time estimation, security-by-design. | — |
| **02** | **Git Workflow** | [ID](skills/02-git-workflow/SKILL.md) \| [EN](skills/02-git-workflow/SKILL.en.md) \| [ZH](skills/02-git-workflow/SKILL.zh.md) \| [AR](skills/02-git-workflow/SKILL.ar.md) | Git Flow / Trunk-based branching, Conventional Commits, PR workflow, Rich Annotated Tags. | [PR Template](skills/02-git-workflow/examples/pull-request-template.md) |
| **03** | **Frontend Development** | [ID](skills/03-frontend-development/SKILL.md) \| [EN](skills/03-frontend-development/SKILL.en.md) \| [ZH](skills/03-frontend-development/SKILL.zh.md) \| [AR](skills/03-frontend-development/SKILL.ar.md) | Responsive Web Design (Mobile-First RWD), Angular 17+ (Signals), React, 4-Language UI (Arabic RTL), Single-Session. | — |
| **04** | **Backend Development** | [ID](skills/04-backend-development/SKILL.md) \| [EN](skills/04-backend-development/SKILL.en.md) \| [ZH](skills/04-backend-development/SKILL.zh.md) \| [AR](skills/04-backend-development/SKILL.ar.md) | Polyglot Microservices, .NET 10 LTS Native AOT, HTTP Security Headers, RFC 7807 Error, Redis Caching. | — |
| **05** | **Code Review & Standards** | [ID](skills/05-code-review-standards/SKILL.md) \| [EN](skills/05-code-review-standards/SKILL.en.md) \| [ZH](skills/05-code-review-standards/SKILL.zh.md) \| [AR](skills/05-code-review-standards/SKILL.ar.md) | Review ethics, Clean Code (SOLID/DRY), Pre-commit hooks (Husky), Multi-language Linter gates. | [Linter Config](skills/05-code-review-standards/examples/linter-config-examples.js) |
| **06** | **Integration** | [ID](skills/06-integration/SKILL.md) \| [EN](skills/06-integration/SKILL.en.md) \| [ZH](skills/06-integration/SKILL.zh.md) \| [AR](skills/06-integration/SKILL.ar.md) | API Gateway routing, Strict CORS, Correlation ID distributed tracing, internal mTLS, Contract testing. | — |
...
| **08** | **CI/CD Pipeline** | [ID](skills/08-cicd-pipeline/SKILL.md) \| [EN](skills/08-cicd-pipeline/SKILL.en.md) \| [ZH](skills/08-cicd-pipeline/SKILL.zh.md) \| [AR](skills/08-cicd-pipeline/SKILL.ar.md) | Pipeline stages (Lint ➔ Test ➔ Scan ➔ Deploy), GitHub Actions / GitLab CI, Automated rollback. | [GitHub CI](skills/08-cicd-pipeline/examples/ci-build-test.yml) |
| **09** | **Deployment & Docker** | [ID](skills/09-deploy/SKILL.md) \| [EN](skills/09-deploy/SKILL.en.md) \| [ZH](skills/09-deploy/SKILL.zh.md) \| [AR](skills/09-deploy/SKILL.ar.md) | Multi-stage Dockerfiles, Kubernetes manifests, Helm, Nginx Reverse Proxy, Let's Encrypt SSL. | [Dockerfile](skills/09-deploy/examples/Dockerfile.multistage.example) |
| **10** | **Monitoring & Observability** | [ID](skills/10-monitoring-observability/SKILL.md) \| [EN](skills/10-monitoring-observability/SKILL.en.md) \| [ZH](skills/10-monitoring-observability/SKILL.zh.md) \| [AR](skills/10-monitoring-observability/SKILL.ar.md) | 3 Observability Pillars (Metrics, Logs, Traces), Prometheus/Grafana, Alerting rules, Incident runbooks. | — |
